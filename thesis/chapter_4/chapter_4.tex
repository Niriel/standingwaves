...
In his technical note \citetitle{risacher2011standingwaves}~\cite{risacher2011standingwaves}, \citeauthor{risacher2011standingwaves} confirms that the LO--mixer ripples are not detected in Band~1.
...
which is described in the~\citetitle{hifiobserversmanual}~\cite{hifiobserversmanual}.
This pipeline applies the reference subtraction and the bandpass calibration described by \citeauthor{ossenkopf2002intensity} in~\citetitle{ossenkopf2002intensity}~\cite{ossenkopf2002intensity}.
...
\begin{table}[hbtp]
    ...
    \caption{
        ...
        Source: \todo[inline]{Willem Jellema's thesis}
    }
