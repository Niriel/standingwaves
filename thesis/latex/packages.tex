...
% to page 1.
\usepackage{float}
% This does not seem to be true.  I am now loading algorithm first and not loading float.
% Somehow this is working anyway.  I do not know what changed.
% I did delete ALL temporary files before compiling.  LaTeX magic.

% According to
% http://tex.stackexchange.com/questions/113719/cleveref-fails-to-reference-algorithms
% Algorithm must be loaded before hyperref.
