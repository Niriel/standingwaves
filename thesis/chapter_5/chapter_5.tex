...
Since they are close, we averaged them\todo{Floris asked ``assuming which o/p ratio for H2?''.  I averaged with (o+p)/2 but Floris' question seems to suggest that a weighted average makes sense.  Check and proceed}.
...
They do so by aligning the polarization of the sky and the LO signals with that of the mixers (see~\cref{sec:diplexer_lo_injection,sec:annex_a}).
